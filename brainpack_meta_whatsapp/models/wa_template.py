...
class WATemplate(models.Model):
    ...
    def init(self):
        video_path = get_module_resource('brainpack_meta_whatsapp', 'static/src/video', 'wa-demo-video.mp4')
        ...
        pdf_path = get_module_resource('brainpack_meta_whatsapp', 'static/src/pdf', 'TestPDFfile.pdf')
        ...
        pdf_path = get_module_resource('brainpack_meta_whatsapp', 'static/src/image', 'whatsapp_default_set.png')
    ...
    # def init(self):
    #     video_path = get_module_resource('brainpack_meta_whatsapp', 'static/src/video', 'whatsapp_in_chatter.mp4')
