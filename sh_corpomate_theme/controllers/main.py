...
#         ]
        ...
        if is_readymade_theme_changed:
            ...
            list_page_theme_5 = [
                ...
                'sh_corpomate_theme.sh_corpomate_tmpl_gallery_5',
            ]
            list_page_theme_6 = [
            ...
            theme_none_list_page = list_page_theme_1 + list_page_theme_2 + \
                list_page_theme_3 + list_page_theme_4 + list_page_theme_5 + list_page_theme_6 + list_page_theme_7
            ...
            if dic_page_view_ids_list:
                ...
                ### Onemate Menus
                onemate_menus_urls = [ 'about2','services16','counter7','portfolio',
                                      'team77','testimonial8','hotspot9','events55',
                                      'contact85']
                    
                if selected_readymade_tmpl != "sh_corpomate_theme.sh_corpomate_theme_layout_readymade_7":
                    for rec in onemate_menus_urls:
                ...
                if pages and selected_readymade_tmpl != 'sh_corpomate_theme.sh_corpomate_theme_layout_readymade_none':
                    ...
                    for page in pages:
                        ...
                        if search_menu:
                            ...
                            # if '/home' in search_menu.name:
                            #     list_to_delete_home_page_menu_ids.append(
                            #         search_menu.id)
                            #     continue
